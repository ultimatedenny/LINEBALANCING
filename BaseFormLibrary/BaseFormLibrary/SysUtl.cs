...
public static class SysUtl
{
    ...
    public static string DefaultSqlConStr = "";
    public static byte[] RoleCookie;
    public static bool ConnectionStatus = false;
    public static DataSet dsXMLConfig = new DataSet();
    public static String SysNam = "";// ConfigurationManager.AppSettings["SystemName"].ToString();
    public static String ErrPath = ""; //ConfigurationManager.AppSettings["ErrLogPath"].ToString()
    public static IntPtr admin_token = IntPtr.Zero;
    //public static SqlConnection SqlConHd;
    public static int TotalConStr = 10;
    //public static SqlConnection SqlConHd = new SqlConnection();
    public static SqlConnection[] PSqlConHd = new SqlConnection[TotalConStr]; // maximum 10 persistent connection

    //*****************************************************************************
    //                                    WINAUTH 
    //*****************************************************************************
    public static Boolean WinAuth(String UsrNam, String PasWrd, String ConStr, bool UseRole, String RoleName, String RolePassword, bool DefaultCon = false)
    {
    ...
    public static Boolean Domain_Authentication(string Username, string Password, string domain)
    {
    ...
    public static Boolean IsValid(string Username, string Password, string domain)
    {
    ...
    public static Boolean LoadXMLtoDataSet()
    {
        String xmlfile;
    ...
    //                                   SQLCON 
    //*****************************************************************************
    public static Boolean SQLCon(string ConStr, bool UseRole, String RoleName, String RolePassword, bool DefaultCon = false)
    {
        if (DefaultCon == true)
        {
    ...
    public static SqlConnection SqlConHdDirect = new SqlConnection();
    public static bool DirectSQLCon(string ConStr)
    {
    ...
    public static bool DisconnectDirectSQLCon()
    {
        try
        {
    ...
    public static void SQLCloseCon(string ConStr = "DefaultConStr")
    {
    ...
    //******************************************************************************
    public static string LoadXMLConfiguration(DataSet dsXML, string TableTab, string RowFilter)
    {
    ...
    //                              UpdateConfigSetting
    //*******************************************************************************
    public static void UpdateConfigSetting(string XMLFilePath)
    {
        DataSet set;
        try
        {
    ...
    //                                  ExecuteDTQuery
    //***************************************************************************
    public static DataTable ExecuteDTQuery(String pSqlCmd, SqlTransaction Tranx, string ConStr = "DefaultConStr")
    {
    ...
    //                              ExecuteNonQuery
    //********************************************************************************
    public static Int64 ExecuteNonQuery(string command, SqlTransaction Tranx, string ConStr = "DefaultConStr")
    {
        SqlConnection SelCon = new SqlConnection();
        try
        {
    ...
    //                               ExecuteScalar
    //********************************************************************************
    public static string ExecuteScalar(string command, SqlTransaction Tranx, string ConStr = "DefaultConStr")
    {
        SqlConnection SelCon = new SqlConnection();
        try
        {
    ...
    public static byte[] SetApprole(SqlConnection connection, string approle, string approlePassword)
    {
    ...
    public static void UnsetApprole(SqlConnection connection, byte[] approleCookie)
    {
    ...
    //                              ExecuteDSQuery
    //********************************************************************************
    public static DataSet ExecuteDSQuery(string Command, SqlTransaction Tranx, string ConStr = "DefaultConStr")
    {
        SqlConnection SelCon = new SqlConnection();
        try
        {
    ...
    //********************************************************************************
    public static StringBuilder SqlQueryWithBeginTran(string SqlQuery, string RollBackMsg, string CommitMsg)
    {
    ...
    //                               Export Data
    //********************************************************************************
    public static void ExportData(DataSet dsExport, string FileName = "")
    {
    ...
    //********************************************************************************
    public static void DataSetToExcel(DataSet dsExport, string FilePath, CollapseDirection _direction = CollapseDirection.AskOpenOrNot)
    {
    ...
    //********************************************************************************
    public static void DataTableToTXT(DataTable dtExport, string FilePath, CollapseDirection _direction = CollapseDirection.AskOpenOrNot)
    {
    ...
    //********************************************************************************
    public static void DataTableToDBF(DataTable dataFromSQL, string FilePath, CollapseDirection _direction = CollapseDirection.PromtInformation)
    {
    ...
    //********************************************************************************
    public static void DataTableToPDF(DataTable dtExport, string FilePath, bool Landscape, CollapseDirection _direction = CollapseDirection.AskOpenOrNot)
    {
    ...
    //********************************************************************************
    public static void DataTableToMsWord(DataTable dtExport, string FilePath, CollapseDirection _direction = CollapseDirection.AskOpenOrNot)
    {
    ...
    //********************************************************************************
    public static void DataTableToMsAccess(DataTable dtExport, string FilePath)
    {
    ...
    //********************************************************************************
    public static void DataTableToHTML(DataTable dtExport, string FilePath, CollapseDirection _direction = CollapseDirection.AskOpenOrNot)
    {
    ...
    public static string GetCtlNum(string lcComCod, string lcPeriod, string lcCtlFld)
    {
    ...
    public static bool SavErrLog(string log, Exception ex = null)
    {
        if (ex == null)
        {
    ...
    public static bool StringToText(string str, string FileName, string Path = @"C:\Expana\")
    {
        try
        {
    ...
    //public static bool SavErrLog(string log)
    //{
    //    log = log.Replace("'", "''");
    //    string ErrPth = ErrPath + "\\ERR_" + DateTime.Now.ToString("ddMMyy_hhmmss") + ".txt";
    ...
    public static string CharIncreament(string Str)
    {
        string Rsl = "";
        if (Str == "")
        {
    ...
    public static DataTable TableToQRCode(DataTable dtQR, List<string> ColNam)
    {
    ...
    //public static DataTable TableToEAN(DataTable dtEAN, List<string> CC, List<string> MC, List<string> PC, List<string> CD)
    public static DataTable TableToEAN(DataTable dtEAN, List<string> ColNam, float EANscale, int flipDegree)
    {
        DataTable dtTmp = new DataTable();
        dtTmp = dtEAN.Copy();
    ...
    public static byte[] StringToQRtoByte(string str)
    {
    ...
    public static byte[] StringToEANtoByte(string EAN, float EANscale, int flipDegree)
    {
        //gaby
    ...
    public static Int64 DataTableToSQLTable(DataTable dt, string SqlTableDestination, bool ClearSqlDestinationTable, string ConStr = "DefaultConStr")
    {
        try
        {
    ...
    public static string BaseFormVersion()
    {
        string Ver = "";
    ...
    //********************************************************************************
    public static DataTable DatagridviewToDataTable(DataGridView dgv, GridID DataGridviewID = GridID.Name)
    {
        DataTable dt = new DataTable();
    ...
    public static System.Drawing.Image StringToEAN13(string CountryCode, string ManufacturerCode, string ProductCode, string ChecksumDigit)
    {
        Ean13 ean13 = new Ean13();
        ean13.CountryCode = CountryCode;
        ean13.ManufacturerCode = ManufacturerCode;
