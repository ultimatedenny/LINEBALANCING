...
namespace BaseFormLibrary
{
    public class Ean13
    {
        ...
        //private float _fMinimumAllowableScale = 0.08f;
        private float _fMinimumAllowableScale = 0.003f; //Gaby
        private float _fMaximumAllowableScale = 200.0f;

        // This is the nomimal size recommended by the EAN.
        // Gaby 20180415: Skala panjang : tinggi = 1.4 : 1
        ...
        private void ClearColor(PaintEventArgs e)
        {
            ...
            e.Graphics.Clear(System.Drawing.Color.Teal);
        }
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt)
        {
            ...
            //g.PageScale = 1;
            //g.PageScale = g.PageScale * width  * 2;
            g.PageScale = 8f;
            ...
            //System.Drawing.Font font = new System.Drawing.Font("Arial", this._fFontSize * this.Scale * (g.PageScale * 10));
            System.Drawing.Font font = new System.Drawing.Font("Arial", this._fFontSize * this.Scale * (24), System.Drawing.FontStyle.Bold);
            ...
            //Gaby 20180411
            // To Create Solid Brush , then rectangle, then fill into rectangle to avoid blackbox effect in crystal report
        ...
        public System.Drawing.Bitmap CreateBitmap()
        {
            ...
            //tempHeight = Convert.ToInt64((float)(Math.Round((double)tempHeight, 2)));
            //tempWidth = Convert.ToInt64((float)(Math.Round((double)tempWidth, 2)));
